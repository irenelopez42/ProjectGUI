...
nlep_string = StringVar()
nlep_string.set("0") # initialize a string for number of leptons

b1_lep = Radiobutton(frame1, text="1 Lepton",
                        variable=nlep_string, value="1")
b2_lep = Radiobutton(frame1, text="2 Leptons",
                        variable=nlep_string, value="2")
b3_lep = Radiobutton(frame1, text="3 Leptons",
                        variable=nlep_string, value="3")
b4_lep = Radiobutton(frame1, text="4 Leptons",
                        variable=nlep_string, value="4")
...
njet_string = StringVar()
njet_string.set("0") # initialize a string for number of jets

b1_jet = Radiobutton(frame1, text="1 Jet",
                        variable=njet_string, value="1")
b2_jet = Radiobutton(frame1, text="2 Jets",
                        variable=njet_string, value="2")
b3_jet = Radiobutton(frame1, text="3 Jets",
                        variable=njet_string, value="3")
b4_jet = Radiobutton(frame1, text="4 Jets",
                        variable=njet_string, value="4")
b5_jet = Radiobutton(frame1, text="5 Jets",
                        variable=njet_string, value="5")
b6_jet = Radiobutton(frame1, text="6 Jets",
                        variable=njet_string, value="6")
