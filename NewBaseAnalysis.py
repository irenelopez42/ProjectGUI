...
import Analysis.HistManager as HM
import Analysis.EventCounter as EC
...
class Analysis(object):
    ...
    def __init__(self, auxName):
        ...
        self.EventCounter = EC.EventCounter(self.TotName)
 	self.HistManager  = HM.HistManager(self.TotName)
