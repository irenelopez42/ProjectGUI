...
def getStandardHistogram(name):
    if (name == "vxp_z"):           return ROOT.TH1D("vxp_z",           "Primary Vertex Position; z_{Vertex} [mm]; Events", 40, -200,200)
    ...
    if (name == "jet_m"):           return ROOT.TH1D("jet_m",           "Jet Mass; m^{jet} [GeV]; Jets", 20, 0, 20)
